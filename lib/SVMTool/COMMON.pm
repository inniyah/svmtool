...
sub trim($) {
    #description _ removes whitespace from the start and end of the string
    #param1  _ input string
    #@return _ trimmed output string
...
sub ltrim($) {
    #description _ removes leading whitespace (i.e., from the start of the string)
    #param1  _ input string
    #@return _ trimmed output string
...
sub rtrim($) {
    #description _ removes trailing whitespace (i.e., from the start and end of the string)
    #param1  _ input string
    #@return _ trimmed output string
